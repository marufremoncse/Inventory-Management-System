                            ...
                            <form enctype="multipart/form-data" action="{{route('product.store')}}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="InputCode" name="product_code" placeholder="Product Code">
                                    </div>
                                    <div class="form-group">
                                        <label for="InputQuantity">Stock</label>
                                        <input type="text" class="form-control" id="InputQuantity" name="quantity_available" placeholder="Stock">
                                    </div>
                                </div>
                                <!-- /.card-body -->
